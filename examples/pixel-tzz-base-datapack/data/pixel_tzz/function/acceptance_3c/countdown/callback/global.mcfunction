...
$data modify storage pixel_tzz:acceptance_3c countdown.callbacks append value {scope:"global",game_id:"$(game_id)",game_instance_id:"$(game_instance_id)",countdown_id:"$(countdown_id)",countdown_instance_id:"$(countdown_instance_id)",slot:"$(callback_slot)",callback_id:"$(callback_id)",reason:"$(reason)",total_ticks:$(total_ticks),remaining_ticks:$(remaining_ticks)}
