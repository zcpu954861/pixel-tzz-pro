...
public final class ModSettingsScreen extends Screen {
	...
	protected void init() {
		...
		CategoryButton countdown = new CategoryButton(
			CARD_X,
			...
			Component.translatable("pixel_tzz_pro.settings.countdown.description"),
			"T−",
			SUCCESS,
			button -> this.minecraft.gui.setScreen(new CountdownSettingsScreen(this))
		);
		countdown.setTooltip(Tooltip.create(Component.translatable("pixel_tzz_pro.settings.countdown.tooltip")));
		this.addRenderableWidget(countdown);
